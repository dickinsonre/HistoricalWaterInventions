...
export const gameData: GameData = {
  regions: [
    ...
    },
    {
      id: "carthage",
      name: "Carthage",
      description: "Carthage solved an impossible problem: building a city of 500,000 people with no nearby river. The Zaghouan aqueduct — stretching 132 km from mountain springs across the Tunisian highlands — was among the longest in the ancient world, crossing valleys on arched bridges up to 20 meters high and delivering an estimated 32 million liters per day. At its terminus, the La Malga cisterns complex — 24 parallel barrel-vaulted chambers — stored over 50 million liters of water, the largest ancient cistern system ever built. The city's circular cothon military harbor, with an artificial admiralty island at its center, could dock 220 warships in individual covered dry docks arranged radially around the basin, connected to a rectangular commercial port handling Mediterranean trade. Engineered water circulation channels carved through the cothon walls flushed sediment with tidal action to prevent silting. Carthaginian engineers invented opus signinum — crushed pottery mixed with lime to create waterproof hydraulic cement — a technology so effective that Rome adopted it for their own aqueducts and baths. The city's tophet precinct and residential quarters were served by an intricate network of terracotta pipes and stone-lined drains. Phoenician engineering perfected on African soil, Carthage proved that mastery of water could sustain a superpower even in a semi-arid landscape.",
      position: [3, 0, 0],
      color: "#8B0000",
      era: "classical",
