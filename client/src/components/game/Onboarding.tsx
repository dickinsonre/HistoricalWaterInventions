...
const slides = [
  {
    ...
    content: "Explore 217+ civilizations and discover 1,143+ water inventions across 6 continents. From 2.8-million-year-old lakeside camps to Aboriginal fish traps to Tokyo's G-Cans flood control.",
    stats: [
      { value: "217+", label: "Civilizations" },
      { value: "1,143+", label: "Inventions" },
