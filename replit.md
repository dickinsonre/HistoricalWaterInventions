...
- **Multilingual Names**: Native-language/script names for all 216 civilizations displayed on cards, tooltips, and detail pages (Arabic, Chinese, Greek, Sanskrit, Khmer, Latin, etc.).

### Data Structure
- **Regions**: 216 civilizations with era, date range, position, color.
